...
import ChartsDon from '../../Admin/Components/Charts/ChartsDon';
...
const Charts = () => {
    ...
    const { data: dataDep } = useFetchData(`/chart/dependencia`);
    console.log()
    useEffect(() => {
        setChartData({
                                ...
                                <div className="container-fluid px-4">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="card mb-4">
                                                <div className="card-header">
                                                    ...
                                                    Solicitudes generales por estado
                                                </div>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="card mb-4">
                                                <div className="card-header">
                                                    ...
                                                    Solicitudes generales por tipo de soporte
                                                </div>
                                        ...
                                        <div className="card mb-4">
                                            <div className="card-header">
                                                <i className="fas fa-chart-pie me-1"></i>
                                                Solicitudes generales por dependencia
                                            </div>
                                            <div className="card-body">
